...
class CLIPEncoder(nn.Module):
    ...
    def __init__(self, config: CLIPConfig,V_Rank):
        super().__init__()
        self.config = config
...
class CLIPVisionTransformer(nn.Module):
    def __init__(self, config: CLIPVisionConfig,V_rank):
        super().__init__()
        self.config = config
        embed_dim = config.hidden_size
        ...
        self.encoder = CLIPEncoder(config,V_rank)
...
class CLIPVisionModel(CLIPPreTrainedModel):
    ...
    def __init__(self, config: CLIPVisionConfig, V_rank):
        super().__init__(config)
        self.vision_model = CLIPVisionTransformer(config,V_rank)
